...
void main() {
  ...
  testWidgets(
      'ATC: removed seat excluded from stats/Elo/history; remaining '
    ...
    // A works through 1-20 (trebles, thanks to countMultiples) while B
    // misses each turn. With C removed, B is the only other active seat —
    // once A finishes the round resolves and the game ends immediately.
